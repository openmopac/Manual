...
#            print(f"HTML file: {root}/{file}")
            ...
            content_list, target_list = split_at_target(content, head, target, tail)

            fix_list = []
            for item in target_list:
                fix = fix_target(root, item, target_dict, file)
                fix_list.append(fix)
#                if item[1:12] != 'javascript:':
#                    print("link target:", item, "->", fix)

            content = merge_from_target(content_list, fix_list)
